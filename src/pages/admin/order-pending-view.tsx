        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <Card className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Change the order status to accept or decline the pending order.
              </p>
              ...
              <Button
                ...
                disabled={isOrderLoading || updateOrderStatus.isPending}
              >
                Accept
              </Button>
              <form onSubmit={handleSubmit(submitDecline)}>
                <div className="space-y-4">
