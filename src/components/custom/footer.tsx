      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-2xl font-bold">CELESTIAL BLOOM</h3>
            <p className="text-sm opacity-90">
              Premium flowers and gifts for your beloved. Quality,
              sustainability, and elegance in every arrangement.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm opacity-70">
            &copy; {currentYear} CELESTIAL BLOOM. All rights reserved.
          </p>
